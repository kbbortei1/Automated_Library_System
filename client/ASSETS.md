...
The photo panel applies a two-part scrim — a flat tint plus a vertical falloff that darkens the
top and bottom — so a replacement shot with different exposure should still keep the overlaid
text legible. The copy also carries a soft text-shadow as a second line of defence.
